                   ...
                   <div class="container">
                       <div class="row">
                           ...
                           <div class="col-xs-10 col-xs-offset-1 col-md-7 col-md-offset-0">
                               ...
                               <!-- Image -->
                               <div class="img">
                                   <img src="{{  asset('images/slideshow/img-01.png') }}" alt="">
                               </div>
                   ...
                   <div class="container">
                       <div class="row">
                           ...
                           <div class="col-xs-10 col-xs-offset-1 col-md-7 col-md-offset-0">
                               ...
                               <!-- Image -->
                               <div class="img">
                                   <img src="{{  asset('images/slideshow/img-02.png') }}" alt="">
                               </div>
                   ...
                   <div class="container">
                       <div class="row">
                           ...
                           <div class="col-xs-10 col-xs-offset-1 col-md-7 col-md-offset-0">
                               ...
                               <!-- Image -->
                               <div class="img">
                                   <img src="{{  asset('images/slideshow/img-03.png') }}" alt="">
                               </div>
                ...
                <div class="shop-item hover-sdw timer"
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="hover" src="{{  asset('images/shop/img-01-1.jpg') }}" alt="">
                                <img class="main" src="{{  asset('images/shop/img-01.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-02.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-03.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="hover" src="{{  asset('images/shop/img-04-1.jpg') }}" alt="">
                                <img class="main" src="{{  asset('images/shop/img-04.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="hover" src="{{ asset('images/shop/img-05-1.jpg') }}" alt="">
                                <img class="main" src="{{  asset('images/shop/img-05.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw timer"
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-06.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{ asset('images/shop/img-07.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="hover" src="{{ asset('images/shop/img-08-1.jpg') }}" alt="">
                                <img class="main" src="{{  asset('images/shop/img-08.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-09.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-10.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-11.jpg') }}" alt="">
                            </div>
                ...
                <div class="shop-item hover-sdw">
                    ...
                    <div class="wrap">
                        ...
                        <div class="body">
                            ...
                            <!-- Image -->
                            <div class="image">
                                <img class="main" src="{{  asset('images/shop/img-12.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="owl-carousel owl-default latest-on-blog nav-bottom-right">
                            ...
                            <div class="blog-item">
                                <div class="wrap">
                                    ...
                                    <!-- Image -->
                                    <div class="image">
                                        <img src="{{  asset('images/blog/img-01.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="blog-item">
                                <div class="wrap">
                                    ...
                                    <!-- Image -->
                                    <div class="image">
                                        <img src="{{ asset('images/blog/img-03.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="blog-item">
                                <div class="wrap">
                                    ...
                                    <!-- Image -->
                                    <div class="image">
                                        <img src="{{  asset('images/blog/img-05.jpg"') }} alt="">
                                    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
           ...
           <div class="owl-carousel owl-default brands nav-bottom-right">
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{ asset('images/brands/img-2-01.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-02.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-03.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-04.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-05.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-06.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-07.png') }}" alt="">
                   </div>
               </div>
               ...
               <div class="img-item">
                   <div class="wrap">
                       <img src="{{  asset('images/brands/img-2-08.png') }}" alt="">
                   </div>
               </div>
           </div>
        </div>
